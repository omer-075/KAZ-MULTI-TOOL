...
echo                                                ║ [38;2;0;255;0m 9) BYPASS ADMIN      [38;2;229;255;229m ║
echo                                                ╚════╦═══════════════════╝
echo                                                     ║
echo                                                     ║
...
echo            [38;2;195;0;0m║
echo            [38;2;225;0;0m║
set /p exe=".          [38;2;255;0;0m╚══════[APP]═══> [38;2;138;43;226m"
if not exist "%exe%" (
    echo the file "%exe%" doesnt exist :(
    pause
    exit /b
)
cmd /min /C "set __COMPAT_LAYER=runasinvoker && start "" "%exe%"" goto menu 
goto menu 
pause>nul
goto menu                                           
pause>nul
